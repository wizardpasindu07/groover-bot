...
bot.on("message", async (message) => { // eslint-disable-line
    ...
    if (command === "help" || command === "cmd") {
        const helpembed = new MessageEmbed()
            ...
            .setDescription(`__**Command list for the Groover bot**__\n> \`g!play / g!p\` > **\`play [title OR url]\`**\n> \`g!search\` > **\`search [title of the song]\`**\n> \`g!skip\` > **\`skip the song currently playing\`**\n> \`g!stop\` > **\`stop the song currently playing\`**\n>  \`g!pause\` > **\`pause the song currently playing\`**\n>  \`g!resume\` > **\`resume the song currently playing\`**\n> \`g!nowplaying / g!np\` > **\`shows the currently playing song\`**\n>  \`g!queue\` > **\`if there are songs more than one queue will show\`**\n>  \`g!volume / g!volume [volume you need]\` > **\`increase or decrease the volume or shows the current volume\`**\n>  \`g!invite / g!i\` > **\`invite this bot to another server\`**\n> \`=>>If You Want To Learn More About Each Command Simply Type Command Name And Help Ex:'g!playhelp'\``)
